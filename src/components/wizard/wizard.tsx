...
import { StepId, STEP_IMAGE } from "@/lib/wizard-steps";
import {
  createRegistration,
  fetchRegistration,
  patchRegistration,
    ...
    case "collect-sample":
      return (
        <SimpleStep
          ...
          image={STEP_IMAGE["collect-sample"]}
    ...
    case "testing-progress":
      return (
        <TimerStep
          eyebrow="Step 8 out of 9"
          title="Testing"
          image={STEP_IMAGE["testing-progress"]}
